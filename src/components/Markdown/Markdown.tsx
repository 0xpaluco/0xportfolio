...
const mdxComponents: Components = {
    ...
    ul: ({ children }) => <ul className="list-disc ml-4 mt-4 text-white">{children}</ul>,
    li: ({ children }) => <li className="mt-1 text-base text-white">{children}</li>,
    strong: ({ children }) => <strong className="text-base font-semibold text-white">{children}</strong>,
