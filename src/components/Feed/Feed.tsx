        ...
        <div className="flex-1">
          <div className="flex justify-between">
            <Link href={post.href} className="block mt-2">
              ...
              <p className="mt-1 text-base text-gray-500 hidden sm:line-clamp-2">
                {' '}
                {post.description}{' '}
              </p>
            </Link>
            <div className="ml-4 flex-shrink-0">
              <img
                className={classNames(
                  post.imageUrl
                    ? 'h-16 w-16 md:h-24 md:w-24 border border-gray-300 bg-white text-gray-300'
                    : 'hidden',
                )}
                src={post.imageUrl}
                alt=""
          ...
          <div className="mt-3 relative flex items-center justify-between">
            <p className="text-sm font-medium text-indigo-600 block">
              ...
              <span aria-hidden="true">&middot;</span>
              <span className="text-gray-500 font-light mx-1">
