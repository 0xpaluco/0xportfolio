  ...
  return (
    <li className={clsx(className, 'flex')}>
      <Link
        target={"_blank"}
        href={href}
        className="group flex text-sm font-medium text-zinc-800 transition hover:text-c-l-primary dark:text-zinc-200 dark:hover:text-c-l-primary"
      >
        
        <a target={"_blank"} className="group ml-2 flex text-white hover:underline">
