        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-400">
              Schedule a 15-minute zoom meeting to talk shop and nerd out over
              software development.
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-400">
              Choose a date and time that works better for you. During the
              meeting, we’ll dive into your project requirements, timelines, and
              other nerdy stuff.
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-400">
              A confirmation email with all the deets will be sent to you. Can’t
              wait to geek out with you!
            </p>
          </div>
        </div>
        <Calendly />
